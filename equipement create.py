from equipements_management.models import (
    Equipement,
    LocalisationEquipement,
    CategorieEquipement,
    TypeEquipement,
    EtatEquipement
)
...
def create_and_get_types():
    ...
    for category_name, type_names in equipment_types.items():
        ...
        for type_name in type_names:
            type_equip, created = TypeEquipement.objects.get_or_create(
                nom=type_name, categorie=category)
