                              ...
                              <div className="relative">
                                  ...
                                  <input
                                     ...
                                     placeholder="Rechercher (nom, email, rôle...)"
                                      className="w-full text-balck  px-4 py-2 pl-10 rounded-full border border-gray-300 bg-darck shadow-md"
                                      value={searchTerm}
...
<div className="flex items-center justify-start space-x-4 w-full mr-16">
 ...
 {/* Colonne avec l'icône et le nom à droite */}
 


 <div className="flex flex-col items-center justify-start pl-10 w-1/2">
  <div className="flex flex-col items-center" style={{ marginLeft: "-1100px", marginTop: "-480px" }}>
    ...
    <div className="w-[300px] h-[300px] rounded-full overflow-hidden  flex items-center justify-center">
      <label htmlFor="photoUpload" className="w-full h-full cursor-pointer">
        {previewUrl ? (
          ...
          <MdAccountCircle className="text-primary" style={{ fontSize: "300px" }} />
        )}
      </label>
    </div>
