  ...
  return (
    <div className="flex items-center justify-between bg-white rounded-lg shadow-sm pl-3 pr-2 sm:px-4 py-2 w-full">
      ...
      <div className="flex items-center gap-4 flex-grow overflow-hidden text-sm sm:text-base">
        ...
        <span
          className={`sm:hidden flex-shrink-0 w-3 h-3 rounded-full ${urgenceColors[urgence]}`}
        ></span>
        <span
          className={`w-[15%] sm:w-[10%] text-[#202124] overflow-hidden whitespace-nowrap`}
        >
          {id}
        </span>
        <span
          className={`w-[30%] sm:w-[35%] text-[#202124] overflow-hidden whitespace-nowrap`}
        >
          {nom}
        </span>
        ...
        <div className="w-[20%] hidden sm:flex items-center space-x-2">
          <div className="flex items-center space-x-2">
            <span
              className={`flex-shrink-0 w-3 h-3 rounded-full ${urgenceColors[urgence]}`}
            ></span>
            <span
              className={`hidden sm:block text-[#202124] overflow-hidden whitespace-nowrap`}
            >
              {urgence}
            </span>
          </div>
        ...
        <span
          className={`w-[25%] sm:w-[15%] text-[#202124] overflow-hidden whitespace-nowrap ml-auto`}
        >
          {statut}
        </span>
      </div>
