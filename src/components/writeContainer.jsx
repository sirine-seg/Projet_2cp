      ...
      <div className="mb-4">
        ...
        <div className="relative mt-0.25rem">
          <input
            ...
            onBlur={handleBlur}
            placeholder="---"
            className="flex flex-col items-start w-full py-3 px-4 border border-white rounded-[0.5rem] text-[#80868B] text-[0.8125rem] font-regular font-poppins bg-white resize-none focus:outline-0 focus:ring-0"
          />
        </div>
      </div>
    </div>
