export default function DisplayContainer({ title, content, className = "" }) {
	return (
	  <div className={`w-full mx-auto ${className}`}>
		...
		<div className="bg-white flex items-start w-full py-2 px-4 border border-white rounded-[0.5rem] font-regular font-poppins justify-between shadow-md min-h-[40px]">
