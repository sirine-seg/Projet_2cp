    ...
    <div className={`w-full max-w-sm sm:max-w-md md:max-w-lg lg:max-w-xl xl:max-w-2xl mx-auto  px-2 ${className}`}>
      ...
      <div className="mb-4">
        ...
        <div className="relative mt-0.25rem">
          <div className="flex flex-col items-start w-full py-3 px-4 border border-white rounded-[0.5rem] text-[#80868B] text-[0.8125rem] font-regular font-poppins  bg-white overflow-hidden shadow-md">
            {content}
          </div>
        </div>
      </div>
